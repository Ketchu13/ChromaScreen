...
class KlipperScreen(Gtk.Window):
    ...
    def _remove_all_panels(self):
        ...
        for panel in list(self.panels):
            if panel not in ["printer_select", "co_print_splash_screen"]:
                if hasattr(self.panels[panel], "del_obj"):
                    self.panels[panel].del_obj()
    ...
    def show_printer_select(self, widget=None):
        ...
        self.base_panel.visible_menu(False)
        self.show_panel("co_print_change_printer", "co_print_change_printer", _("Printer Select"), 2)
    ...
    def process_update(self, *args):
        ...
        for x in self.subscriptions:
            #print('idle' + x)
            #self.panels[x].process_update(*args)
    ...
    def base_panel_show_all(self):
        ...
        self.base_panel.show_heaters(False)
        self.base_panel.show_estop(False)
